...
public class Wheel extends Applet implements Runnable {

    public static final int TARGET_FPS = 50;
    public static final int ANGLE = 10;
    public static final int ANGLE_VEL = 11;
...
//        Level level = levels.get(0);
        ...
        lineArray.points.add(new Tuple(-1000, -1300));
        lineArray.points.add(new Tuple(1000, -1300));
...
//            }
            ...
            if (intersection.foundCollision) {
                v[A.POS_X] = (intersection.normal.x * v[A.RADIUS] + intersection.closest.x);
                v[A.POS_Y] = (intersection.normal.y * v[A.RADIUS] + intersection.closest.y);
